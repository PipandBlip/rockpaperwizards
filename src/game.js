...
/* Bots wear a RANK, not a special case.
   ...
   Apprentice sits at level 1 — the plain cloth a new player starts in, so a
   beginner sees themselves in it. Adept is halfway up the ladder at six stones.
   Archmage carries ten of the twelve: clearly formidable, and still two short
   of a finished cloak, so there is somewhere left to climb.

   Levels, not gem counts, because then the GEMS table stays the single source
   of truth — retune the ladder and the bots follow it without being touched. */
const BOT_LEVEL = [1, 16, 33];      // Apprentice, Adept, Archmage
